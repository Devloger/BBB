			...
			<div id="container-center">
				<div id="center-welcome">
					<div id="center-welcome-page">
						...
						<p>Witaj na stronie głównej portalu społecznościowego BBB!<br/>
						Zapraszamy serdczenie za rejestracji nowego konta!<br/>
						Po zalogowaniu będziesz mógł już w pełni korzystać ze wszystkich możliwości portalu BBB.<br />
						Zaproś również swoich znajomych!<br/>
						Życzymy miłego i owocnego korzystania z naszego portalu drogi gościu.<br />
						BBB Team<br />
						</p>
					</div>
